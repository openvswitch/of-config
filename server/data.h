...
int txn_del_bridge_queue(const xmlChar *br_name, const xmlChar *resource_id, struct nc_err **e);
int txn_add_bridge_queue(const xmlChar *br_name, const xmlChar *resource_id, struct nc_err **e);
int txn_del_bridge_flow_table(const xmlChar *br_name, const xmlChar *resource_id, struct nc_err **e);
int txn_add_bridge_flow_table(const xmlChar *br_name, const xmlChar *resource_id, struct nc_err **e);
